...
public class SampleSearchItemsApiWithHttpInfo {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Sending the request
            ApiResponse<SearchItemsResponse> response = api.searchItemsWithHttpInfo(searchItemsRequest);
            ...
            // Parsing the request
            if (response.getData() != null && response.getData().getSearchResult() != null) {
                System.out.println("Printing first item information in SearchResult:");
                Item item = response.getData().getSearchResult().getItems().get(0);
                if (item != null) {
