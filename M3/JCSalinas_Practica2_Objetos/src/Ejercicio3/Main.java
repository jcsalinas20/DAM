...
public class Main {
	...
	public static void main(String[] args) {
		...
		v[0] = new Vehicle1(0, 0, null, 0, null, null);
		v[1] = new Vehicle2(0, 0, null, 0, null, null);
		v[2] = new Vehicle3(0, 0, null, 0, null, null);
		v[3] = new Vehicle4(0, 0, null, 0, null, null);
		v[4] = new Vehicle5(0, 0, null, 0, null, null);
		v[5] = new Vehicle6(0, 0, null, 0, null, null);
		v[6] = new Vehicle7(0, 0, null, 0, null, null);
		v[7] = new Vehicle8(0, 0, null, 0, null, null);
		v[8] = new Vehicle9(0, 0, null, 0, null, null);
		v[9] = new Vehicle10(0, 0, null, 0, null, null);
